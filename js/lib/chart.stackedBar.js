                ...
                helpers.each(dataset.data,function(dataPoint,index){
                    if (helpers.isNumber(dataPoint)){
                        ...
                        datasetObject.bars.push(new this.BarClass({
                            ...
                            strokeColor : dataset.strokeColor,
                            fillColor : dataset.highlighted ? dataset.highlighted[index] || dataset.fillColor : dataset.fillColor,
                            highlightFill : dataset.highlighted ? dataset.highlighted[index] || dataset.highlightFill || dataset.fillColor : dataset.highlightFill || dataset.fillColor,
